...
//      Serial.println("SerongKiriBawah");
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   if ( (ps2x.Analog(PSS_RY) < 55) && (ps2x.Analog(PSS_RX) > 200) )                  //SERONG KANAN ATAS RIGHT
    {
      jam();
//      Serial.println("SerongKananAtas");
    }
   if ( (ps2x.Analog(PSS_RY) < 55) && (ps2x.Analog(PSS_RX) < 55) )                   //SERONG KIRI ATAS RIGHT
    {
      balikjam();
//      Serial.println("SerongKiriAtas");
    }
    if ( (ps2x.Analog(PSS_RY) > 200) && (ps2x.Analog(PSS_RX) < 55) )                  //SERONG KIRI BAWAH RIGHT
    {
      balikjam();
//      Serial.println("SerongKananBawah");
    }
    if ( (ps2x.Analog(PSS_RY) > 200) && (ps2x.Analog(PSS_RX) > 200) )                 //SERONG KANAN BAWAH RIGHT
    {
      jam();
//      Serial.println("SerongKiriBawah");
    }
